...
export default function ProfitabilityDashboard() {
  ...
  return (
    <div style={S.page}>
      ...
      {/* ── YTD banner — only when not full year ────────────────────────── */}
      {period !== "P12" && (
        <div style={S.ytdBanner}>
          📅 Showing YTD cumulative data from <strong>P1 (October)</strong> to{" "}
          <strong>{period} ({currentPeriodMonth})</strong> — all charts reflect this period
        </div>
      )}
...
const S = {
  ...
  kpiCard: { background: "white", borderRadius: 12, padding: "10px 14px", minWidth: 120, boxShadow: "0 2px 12px rgba(9,42,94,0.08)", flex: 1 },
