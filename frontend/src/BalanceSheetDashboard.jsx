...
export default function BalanceSheetDashboard() {
  ...
  const displayAvlData   = avlData ?? charts?.assetsVsLiabilities ?? [];
  ...
  return (
    <div style={S.page} id="bs-print">
      ...
      <div style={S.kpiRow}>
        ...
        <div style={S.kpiCard}>
          <div style={S.kpiHeader}>
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={COLORS.navy} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3v18M3 9l9-6 9 6M4 20h16"/><path d="M6 9l-3 7h6L6 9zM18 9l-3 7h6l-3-7z"/></svg>
        ...
        <div style={S.kpiCard}>
          <div style={S.kpiHeader}>
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={COLORS.navy} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="2" width="16" height="20" rx="2"/><line x1="8" y1="6" x2="16" y2="6"/><line x1="8" y1="10" x2="10" y2="10"/><line x1="12" y1="10" x2="14" y2="10"/><line x1="8" y1="14" x2="10" y2="14"/></svg>
            <p style={S.kpiTitle}>Working Capital</p>
          </div>
          <KpiBar value={workingCapital.current} prevValue={workingCapital.previous} up={wcUp} formatter={fmtK}
        ...
        <div style={S.kpiCard}>
          <div style={S.kpiHeader}>
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={COLORS.navy} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/></svg>
        ...
        <div style={S.kpiCard}>
          <div style={S.kpiHeader}>
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={COLORS.navy} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="2" x2="12" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
        ...
        <div style={S.kpiCard}>
          <div style={S.kpiHeader}>
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={COLORS.navy} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="3"/><path d="M6 12h.01M18 12h.01"/></svg>
        ...
        <div style={S.chartCard}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:4 }}>
            ...
            <div style={{ display:"flex", gap:4 }}>
              {[avlYear - 1, avlYear === currentYear ? avlYear : avlYear, currentYear]
          ...
          <div style={S.legendRow}>
            <span style={S.dot(COLORS.blue)}/><span style={S.legendText}>Assets</span>
            <span style={S.dot(COLORS.red)}/><span style={S.legendText}>Liabilities</span>
          </div>
          <ResponsiveContainer width="100%" height={300}>
      ...
      <div style={S.row2}>
        <HBarCard title="Non-Current Assets Details"  data={charts?.nonCurrentAssetsDetail ?? []} height={220}/>
        <HBarCard title="Current Assets Details"      data={charts?.currentAssetsDetail    ?? []} height={220}/>
      </div>
      <div style={S.row2}>
        <HBarCard title="Equity Details"              data={charts?.equityDetail             ?? []} height={180}/>
        <HBarCard title="Current Liabilities Details" data={charts?.currentLiabilitiesDetail ?? []} height={260}/>
      </div>
